...
<head>
	...
	<title>REPAKING</title>
	<link rel="icon" href="dist/img/list.png">
...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/logoBoyolali.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text"> ADMINDUK</span>
			</a>
        ...
        ?>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="?page=upload_izin" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Surat Izin</p>
									</a>
								</li>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
				...
				//suket
				case 'upload_izin':
					include "surat/surat_izin/upload_izin.php";
					break;
				case 'suket-lahir':
				...
				//laki-laki
				case 'Laki-laki':
					include "admin/pend/laki-laki/data_lk.php";
					break;
				//Perempuan
				case 'Perempuan':
					include "admin/pend/perempuan/data_pr.php";
					break;
    ...
    ?>
		...
		<footer class="main-footer">
			<b>DESA REPAKING | KKN TIM 2 UNDIP TAHUN 2023/2034</b>
		</footer>
